...
- **Volumen:** largo × ancho × alto en pulgadas ÷ divisor base × factor dimensional. El equivalente en libras se redondea hacia arriba y se multiplica por la tarifa. El peso real no participa en el precio.
