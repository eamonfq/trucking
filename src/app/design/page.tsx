    ...
    <main className="min-h-screen bg-cream-50 px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
      <div className="mx-auto grid max-w-[1500px] gap-6 lg:grid-cols-[18rem_1fr]">
        ...
        <div className="min-w-0 rounded-[2rem] bg-white/65 p-5 shadow-[inset_0_0_0_1px_rgba(227,222,213,.75)] sm:p-8 lg:p-10">
          ...
          <section id="timeline" className="mt-12 grid gap-5"><div><p className="text-xs font-bold uppercase tracking-[.18em] text-orange-600">Seguimiento</p><h2 className="mt-2 font-display text-2xl font-bold text-navy-950">Línea de tiempo</h2></div><Card className="max-w-2xl shadow-none"><Timeline events={[{ from: null, to: "pre-alertada", actor: "Cliente", at: "2026-08-27", note: "Registro recibido." }, { from: "pre-alertada", to: "recibida", actor: "Operaciones A&L", at: "2026-08-29", note: "Caja inspeccionada." }, { from: "categorizada", to: "en-bodega", actor: "Operaciones A&L", at: "2026-09-01", note: "Lista para crear un envío." }]} /></Card></section>
        </div>
      </div>
    </main>
  );
