...
export const paymentReportSchema = z.object({ amount: z.coerce.number().positive(), method: z.string().min(2), reference: z.string().trim().max(160).default(""), receiptName: z.string().optional() });
