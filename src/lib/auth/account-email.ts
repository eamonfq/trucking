...
export async function sendAccountLink(user: User, purpose: "verify" | "reset" | "invite") {
  ...
  if(purpose==="invite"&&user.role==="admin"){copy.subject="Tu acceso al equipo · A&L";copy.heading="Tu espacio de trabajo está listo";copy.body=`Hola ${user.firstName}. Te asignaron acceso al panel operativo de A&L. Crea tu contraseña para confirmar tu correo. Al ingresar verás las herramientas autorizadas. El enlace es personal y vence en 24 horas.`;}
